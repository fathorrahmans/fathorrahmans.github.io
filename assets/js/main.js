    ...
    var imJs = {
        ...
        contactForm: function () {
            $('.rwt-dynamic-form').on('submit', function (e) {
                ...
                if(jsonObj.name == '') {
                    _self.find('.rn-btn').after('<div class="error-msg"><p>*Name can not be empty!</p></div>');
                } else if(jsonObj.phone == '') {
                    _self.find('.rn-btn').after('<div class="error-msg"><p>*Phone Number can not be empty!</p></div>');
                } else if(jsonObj.email == '') {
                    _self.find('.rn-btn').after('<div class="error-msg"><p>*Email can not be empty!</p></div>');
                } else if(jsonObj.subject == '') {
                    _self.find('.rn-btn').after('<div class="error-msg"><p>*Subject can not be empty!</p></div>');
                } else if(jsonObj.message == '') {
                    _self.find('.rn-btn').after('<div class="error-msg"><p>*Message can not be empty!</p></div>');
                } else {
                    ...
                    _self.find('.rn-btn').after('<div class="success-msg"><p>' + "Berhasil" + '</p></div>');
                    setTimeout(function () {
